...
public:
	...
	template<class W>
	shared_ptr<ScalarLookupTable<W> > readScalarLookupTable(const string& variableName) const;
...
template<class W>
shared_ptr<ScalarLookupTable<W> > LookupTableReader::readScalarLookupTable(const string& variableName) const {
    ...
    case Constants::TYPE_BYTE: {
        ...
        return ScalarLookupTable<W>::newScalarLookupTable(variableName, dimensions, values, scaleFactor, addOffset);
    }
...
template<class W>
shared_ptr<VectorLookupTable<W> > LookupTableReader::readVectorLookupTable(const string& variableName) const {
    using std::accumulate;
    using std::multiplies;
    ...
    case Constants::TYPE_BYTE: {
        shared_array<int8_t> values(new int8_t[valueCount]);
        NetCDF::getVariableData(fileId, varId, valarray<size_t>(dimensionCount), dimensionLengths, values.get());
        return VectorLookupTable<W>::newVectorLookupTable(variableName, dimensionLengths[dimensionCount - 1], dimensions, values, scaleFactor, addOffset);
    }
    case Constants::TYPE_UBYTE: {
        shared_array<uint8_t> values(new uint8_t[valueCount]);
        NetCDF::getVariableData(fileId, varId, valarray<size_t>(dimensionCount), dimensionLengths, values.get());
...
template<class W>
shared_ptr<MatrixLookupTable<W> > LookupTableReader::readMatrixLookupTable(const string& variableName) const {
    using std::accumulate;
    using std::multiplies;
    ...
    case Constants::TYPE_BYTE: {
        shared_array<int8_t> values(new int8_t[valueCount]);
        NetCDF::getVariableData(fileId, varId, valarray<size_t>(dimensionCount), dimensionLengths, values.get());
        return MatrixLookupTable<W>::newMatrixLookupTable(variableName, dimensionLengths[dimensionCount - 2], dimensionLengths[dimensionCount - 1], dimensions, values, scaleFactor, addOffset);
    }
    case Constants::TYPE_UBYTE: {
        shared_array<uint8_t> values(new uint8_t[valueCount]);
        NetCDF::getVariableData(fileId, varId, valarray<size_t>(dimensionCount), dimensionLengths, values.get());
