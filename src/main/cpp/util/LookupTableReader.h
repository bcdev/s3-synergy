...
template<class W>
shared_ptr<ScalarLookupTable<W> > LookupTableReader::readScalarLookupTable(const string& varName) const {
	...
	case Constants::TYPE_BYTE: {
		...
		return ScalarLookupTable<W>::newScalarLookupTable(varName, dimensions, values, scaleFactor, addOffset);
	}
