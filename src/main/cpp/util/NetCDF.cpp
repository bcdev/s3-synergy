...
int NetCDF::defineVariable(int fileId, const string varName, int type, int dimCount, const valarray<int> dimIds) {
    int varId;
    int status = nc_def_var(fileId, varName.c_str(), type, dimCount, &dimIds[0], &varId);
