...
void DictionaryParserTest::testSentinel3L1cProductDescriptor() {
    ...
    const ProductDescriptor& p = dictionary->getProductDescriptor(Constants::PRODUCT_L1C);
    ...
    const SegmentDescriptor& olcTime = p.getSegmentDescriptor(Constants::SEGMENT_OLC_TIME);

    CPPUNIT_ASSERT(olcTime.hasVariableDescriptor("time"));

    CPPUNIT_ASSERT(p.hasSegmentDescriptor(Constants::SEGMENT_SLN));
    const SegmentDescriptor& sln = p.getSegmentDescriptor(Constants::SEGMENT_SLN);
    ...
    const SegmentDescriptor& slo = p.getSegmentDescriptor(Constants::SEGMENT_SLO);
...
void DictionaryParserTest::testSynergyL2ProductDescriptor() {
    ...
    const ProductDescriptor& p = dictionary->getProductDescriptor(Constants::PRODUCT_SYL2);
